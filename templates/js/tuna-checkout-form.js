  ...
  $
    ...
    var optionsBoleto =  {
        onKeyPress: function(cep, e, field, options) {
          ...
          $('#tuna_boleto_document').mask(mask, options);
      }};
      
      
    $('#tuna_boleto_document').mask('000.000.000-00',optionsBoleto);
    ...
    if ($("input[name='payment_method']:checked").val() === "tuna_payment") {
        if (
          ...
          $("#tuna_is_crypto_payment").val() !== "true"
            ...
            if (!tuna) {
                let tuna = Tuna("");
                isDocumentValid = new BuyerDocumentFormatter(["999.999.999-99","99.999.999/9999-99"],  validaDocumentoTuna, "CPF / CNPJ").validationFunction($("#tuna_boleto_document").val());
            } else
                isDocumentValid = new BuyerDocumentFormatter(["999.999.999-99","99.999.999/9999-99"],  validaDocumentoTuna, "CPF / CNPJ").validationFunction($("#tuna_boleto_document").val());
