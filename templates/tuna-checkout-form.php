...
<div id="boletoPaymentDocumentDiv" style="display: none;">
    ...
    <label id="lblCPFBoleto" class="defaultTunaLabel">CPF/CNPJ</label>
    <input class="defaultTunaInputText" type="text" name="tuna_document" id="tuna_boleto_document" required />
    <span id="boleto_document_invalid_message" class="defaultTunaValidation" style="display: none;">Por favor, insira um CPF/CNPJ válido</span>
</div>
